...
@register_task_class
class DrawerTask:
    """Skeleton implementation of the bimanual drawer task."""
    ...
    def build_scene(self, model: Any) -> None:
        raise NotImplementedError("Phase 2 will populate the Newton scene for the drawer task.")
